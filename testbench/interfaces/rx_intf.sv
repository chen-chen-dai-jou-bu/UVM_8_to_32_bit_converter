/***************************************************************************
 * Design Name      : RX Engine Interface
 * Function         : Bundle signals for RX Engine DUT and UVM testbench
 * File Name        : testbench/interfaces/rx_intf.sv
 * Original Author  : Michael Su, Sr. Consultant, Sicada, Taiwan
 * Version          : 2.0 (to cope with HW1_RX 2.0)
...
interface rx_intf (input bit clk, rst_n);
  ...
  // --------------------------------------------------------------------
  logic         conv_en;		// Conversion enable (start 8??2 packing)
  ...
  // Modports
  // --------------------------------------------------------------------
  // DUT drives valid_out/last/byte_vld/data_out; sees conv_en/rxdv/rxd as inputs.
