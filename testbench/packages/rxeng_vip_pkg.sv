//-----------------------------------------------------------------------------
// File Name : testbench/packages/rxeng_vip_pkg.sv
// Function  : Manage compile order for all RX Engine TB SystemVerilog files
// NOTE      : DO NOT include test classes in this package
//-----------------------------------------------------------------------------

package rxeng_vip_pkg;

  `include "uvm_macros.svh"
  import uvm_pkg::*;

  // ---------- Common used (must put right after typedef) ----------
  `include "packages/common.svh"
  ...
  // ---------- agent ----------
  // interface is used by driver/monitors, include before them
  //`include "interfaces/rx_intf.sv"

  // driver / monitors / agent
  ...
  // DO NOT include rx_test.sv in package

endpackage : rxeng_vip_pkg